  ...
  return (
    <section id="about" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-4xl sm:text-5xl font-bold mb-12 text-text-primary">About</h2>
        ...
        <div className="space-y-8">
          ...
          {/* The Brand */}
          <div className="bg-dark-card border-2 border-dark-border rounded-lg p-8 mt-12">
